    ...
    <nav className="sticky top-0 z-50 text-white shadow-xl" style={{ backgroundColor: '#0a192f' }}>
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/" className="flex items-center gap-3">
          <div className="h-12 bg-white rounded-lg p-1 flex items-center justify-center w-12">
            <span className="font-bold text-black text-sm">QR</span>
          </div>
        ...
        <Link to="/shop" className="relative p-2 hover:text-yellow-300 transition">
          ...
          <span className="absolute -top-1 -right-1 flex items-center justify-center rounded-full w-5 h-5 text-xs font-bold" style={{ backgroundColor: '#FFC107', color: '#0a192f' }}>0</span>
        </Link>
